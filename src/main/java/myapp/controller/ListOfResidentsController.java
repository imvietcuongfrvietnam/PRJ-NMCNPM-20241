...
public class ListOfResidentsController extends ManagementController<Resident>{
    ...
    @FXML
    private TextField nameText, IDcardText, hometownText, phoneText, ethnicityText, nationalityText, occupationText, educationText, houseHoldIDText, statusText, searchText;
    @FXML
